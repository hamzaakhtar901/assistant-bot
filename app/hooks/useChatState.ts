...
export const useChatState = () => {
  ...
  const [assistantModel, setAssistantModel] = useState('gpt-4-turbo');
  ...
  const [initialThreadMessage, setInitialThreadMessage] = useState<string>(process.env.INITIAL_MESSAGE || 'Greetings!');
